...
CREATE TABLE `usuario_usuario_user_permissions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Usuario_usuario_user_per_usuario_id_permission_id_1439ec65_uniq` (`usuario_id`,`permission_id`),
  KEY `Usuario_usuario_user_permission_id_79a787d7_fk_auth_perm` (`permission_id`),
  CONSTRAINT `Usuario_usuario_user_permission_id_79a787d7_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`),
  CONSTRAINT `Usuario_usuario_user_usuario_id_55b21d60_fk_Usuario_u` FOREIGN KEY (`usuario_id`) REFERENCES `usuario_usuario` (`id`)
